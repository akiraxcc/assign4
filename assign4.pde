...
/*---------Make Alien Function-------------*/
void alienMaker(int alienLength, int Col) {
  int Numbers =0;
  ...
  float alienX = i%Col;
  float alienY = i/Col;
  aList[Numbers]= new Alien(Space+(Space-10)*(int)alienX, Space+Space*(int)alienY);
  Numbers++;
  }
}
void drawLife() {
